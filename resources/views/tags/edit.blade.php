            ...
            <div class="bg-white shadow-lg rounded-lg p-6 w-full max-w-md">
                ...
                <form action="{{route('tags.update', $tag)}}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" value="{{@old('name', $tag->name)}}" name="name" required
                    ...
                    <div>
                        ...
                        <input type="text" id="description" value="{{@old('description', $tag->description)}}" name="description" required
                            class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
